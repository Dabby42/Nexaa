...
export class StatsService {
  ...
  async clickCountForCampaigns(campaign_id: number, start_date: string, end_date: string) {
    return await this.linkService.getTotalClicksForCampaign(campaign_id, start_date, end_date);
  }
}
